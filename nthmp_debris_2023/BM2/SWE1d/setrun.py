...
#------------------------------
    ...
    rundata.bouss_data.sw_depth0 = 0.01 #0.06  #0.005
    rundata.bouss_data.sw_depth1 = 0.01 #0.06  #0.005
    ...
    if 1:
        gauge_list = [(0,0.1), (1,14.05), (9,19.25), (51,28.3), (52,35.53)]
        for k,gauge_info in enumerate(gauge_list):
            gaugeno = gauge_info[0]
            xp_g = gauge_info[1]
