...
t, x, eta_wet, u_wet = read_claw(fgframes[0])
eta_plot, = ax1.plot(x, eta_wet, 'b-', lw=0.7, label='GeoClaw SGNa')
...
ax2 = subplot(2,1,2)
u_plot, = ax2.plot(x, u_wet, 'b-', lw=0.7, label='velocity')
...
def update(fgframeno, *update_artists):
    ...
    t, x, eta_wet, u_wet = read_claw(fgframeno)
