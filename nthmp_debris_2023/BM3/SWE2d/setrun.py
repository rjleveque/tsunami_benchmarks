...
#------------------------------
    ...
    clawdata.lower[0] = -12.  # -12.36
    clawdata.upper[0] = 8.

    clawdata.lower[1] = -4
    clawdata.upper[1] = -0.01


    # Number of grid cells: Coarsest grid
    clawdata.num_cells[0] = 200
    clawdata.num_cells[1] = 39
    ...
    clawdata.bc_lower[0] = 'user'  # wall for t<300, then extrap
    ...
    # 0.1m, 0.05, 0.01m 
    amrdata.refinement_ratios_x = [2,5]
    amrdata.refinement_ratios_y = [2,5]
    amrdata.refinement_ratios_t = [2,5]
    ...
    regions.append([1,1,0,1e9,-15,10,-5,0])
    regions.append([2,3,25,1e9,-2,8,-5,0])

    # == setgauges.data values ==
    # for gauges append lines of the form  [gaugeno, x, y, t1, t2]
    
    rundata.gaugedata.gauges.append([1, -11.9, -2.0, 0., 1e10])
    rundata.gaugedata.gauges.append([2, -0.3, -3.0, 0., 1e10])
...
#-------------------
    ...
    #    [topotype, fname]
    topo_data.topofiles.append([3, '../BM3topo.tt3'])
    ...
    if 1:
        ...
        fgout.nx = 800 #320
        fgout.ny = 400 #160
        fgout.x1 = -1.0  # specify edges (fgout pts will be cell centers)
        fgout.x2 = 7.0
        fgout.y1 = -4.
        fgout.y2 = 0.
        fgout.tstart = 0.
