...
c ------------------------------------------------------------------
c
      subroutine bc2amr(q,aux,nrow,ncol,meqn,naux,
     1                  hx, hy, level, time, 
...
c ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::;
      ...
      dimension q(meqn,nrow,ncol), aux(naux,nrow,ncol)
...
c            # only one ghost cell:
             aux(1,1,j) = aux(1,nxl+1,j)  
             q(1,1,j) = h1
             q(2,1,j) = h1*u1
             q(3,1,j) = 0.d0
          else
c            # two ghost cells:
             aux(1,2,j) = aux(1,nxl+1,j)  
             q(1,2,j) = h1
             q(2,2,j) = h1*u1
             q(3,2,j) = 0.d0
             
             h2 = eta2 - aux(1,nxl+1,j)     
 ...
 105    continue
c     write(47,*) t1,q(1,1,2),q(2,1,2)
c     write(48,*) t1,q(1,2,2),q(2,2,2)
